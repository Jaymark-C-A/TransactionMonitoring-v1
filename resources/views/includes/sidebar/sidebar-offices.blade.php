...
<div class="sidebar">
    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <a href="/offices/dashboard" class="nav-link nav-text active">
        ...
        <ul class="nav nav-treeview">
            <li class="nav-item">
            <a href="pages/tables/simple.html" class="nav-link nav-text">
                <i class="fas fa-clipboard-list" style="font-size:24px; padding-right: 10px;"></i>
                <p class="text-sm">Report 1</p>
            </a>
            </li>
            <li class="nav-item">
        ...
        <li class="nav-item">
            <a href="/offices/profile" class="nav-link nav-text">
        ...
        <ul class="nav nav-treeview">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="/account_setting/offices/account-offices" class="nav-link nav-text">
                        <i class="fas fa-user-alt" style="font-size:24px; padding-right: 10px; text-indent: 20px;"></i>
                        <p class="text-sm">Account</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/account_setting/offices/password-offices" class="nav-link nav-text">
